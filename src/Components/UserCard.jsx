...
const UserCard = ({ data }) => {
  ...
  if (!user) return null;
  return (
    <div className="mx-auto w-[75%] h-[75%] bg-gray-950 rounded-t-xl shadow-[2px_2px_10px_var(--color-violet-600)] drop-shadow-xl">
      ...
      <div className="p-2.5 gap-0.5 flex h-[90%]">
        <div className=" scrollbar w-[30%] h-full flex flex-col p-[20px] justify-center gap-[10px] overflow-auto">
        ...
        <div className="w-[70%] h-[100%] overflow-y-auto flex flex-col justify-center gap-2">
